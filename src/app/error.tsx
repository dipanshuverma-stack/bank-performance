...
export default function TerminalError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center p-6 text-center space-y-8">
      <div className="w-20 h-20 bg-destructive/10 rounded-[2rem] flex items-center justify-center text-destructive animate-pulse border border-destructive/20">
      ...
      >
        <RefreshCcw className="w-5 h-5" /> Reboot Module
      </button>
    </div>
  );
}
