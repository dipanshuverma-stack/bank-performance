    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row transition-colors duration-300">
      ...
      <aside className="hidden md:flex w-20 lg:w-72 bg-card border-r flex-col p-6 sticky top-0 h-screen transition-all overflow-y-auto">
        ...
        <nav className="flex-1 space-y-2">
          <Button variant="ghost" asChild className="w-full justify-start text-primary bg-primary/5 font-bold cursor-pointer h-12 rounded-xl">
            <a href="#dashboard">
      ...
      <header className="md:hidden flex items-center justify-between p-4 bg-card border-b sticky top-0 z-30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-headline font-bold text-lg">Elite Performance</span>
        </div>
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <Sheet>
            ...
            <SheetContent side="left" className="w-72 p-0 border-r-0">
               <div className="flex flex-col h-full p-8 bg-card">
                  <div className="flex items-center gap-4 mb-12">
                    ...
                    <div>
                      <span className="font-headline font-extrabold text-xl block">Elite Perf</span>
      ...
      <main className="flex-1 p-4 md:p-8 lg:p-14 overflow-y-auto scroll-smooth">
        <header id="dashboard" className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12 scroll-mt-24">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-md">Your analytics suggest high cognitive load readiness. Focus on Quants today.</p>
          </div>
          ...
          <div className="flex items-center gap-4 self-end md:self-auto">
             <div className="hidden sm:flex items-center bg-card border rounded-2xl px-4 py-2.5 shadow-sm focus-within:ring-2 ring-primary/20 transition-all">
                ...
                <input placeholder="Search metrics..." className="bg-transparent border-none outline-none text-sm w-40 lg:w-56 font-medium" />
             </div>
             ...
             <Button className="rounded-2xl bg-primary hover:bg-primary/90 h-12 px-6 md:px-8 shadow-lg shadow-primary/20 font-bold tracking-tight">
                Mock Connect
             </Button>
          </div>
        </header>
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 rounded-3xl bg-card border-2 border-dashed border-border/60 flex items-center justify-between shadow-sm group hover:border-primary/40 transition-all">
               <div>
                 ...
                 <div className="text-4xl font-headline font-bold tracking-tighter">42</div>
               </div>
        ...
        <section className="space-y-24">
          <div id="timer" className="space-y-8 scroll-mt-28">
             <div className="flex flex-col gap-2">
                ...
                <h2 className="text-2xl md:text-3xl font-headline font-extrabold tracking-tight">Accuracy Console</h2>
             </div>
             <AccuracyTimer />
          </div>
          ...
          <div id="syllabus" className="space-y-8 scroll-mt-28 pb-10">
             <div className="flex flex-col gap-2">
                ...
                <h2 className="text-2xl md:text-3xl font-headline font-extrabold tracking-tight">Syllabus Roadmap</h2>
             </div>
             <SyllabusTracker />
          </div>
        </section>
        ...
        <footer className="mt-24 pt-12 border-t text-center text-sm text-muted-foreground">
          ...
          <p>&copy; 2024 Dipanshu's Elite. Engineered for the 1%.</p>
        </footer>
      </main>
    </div>
  );
